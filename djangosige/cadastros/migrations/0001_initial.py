# Generated by Django 4.2.26 on 2025-11-13 02:09
...
import djangosige.cadastros.validators
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        max_length=255,
                        unique=True,
                        validators=[django.core.validators.MinLengthValidator(1, "Este campo não pode ser vazio.")],
                ...
                ("e_transportadora", models.BooleanField(default=False, verbose_name="É Transportadora")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("criado", models.DateTimeField(auto_now_add=True, verbose_name="Criado")),
                ("modificado", models.DateTimeField(auto_now=True, verbose_name="Modificado")),
                ("e_principal", models.BooleanField(default=False, verbose_name="É Padrão")),
                ("telefone", models.CharField(blank=True, max_length=32, verbose_name="Número")),
                (
                    "pessoa",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="cadastros.pessoa", verbose_name="Pessoa"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("modificado", models.DateTimeField(auto_now=True, verbose_name="Modificado")),
                ("e_principal", models.BooleanField(default=False, verbose_name="É Padrão")),
                ("site", models.URLField(blank=True, max_length=255, verbose_name="URL")),
                (
                    "pessoa",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="cadastros.pessoa", verbose_name="Pessoa"
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("criado", models.DateTimeField(auto_now_add=True, verbose_name="Criado")),
                ("modificado", models.DateTimeField(auto_now=True, verbose_name="Modificado")),
                ("nome_fantasia", models.CharField(blank=True, max_length=36, verbose_name="Nome Fantasia")),
                (
                    "cnpj",
                    models.CharField(
                        blank=True,
                        max_length=14,
                        unique=True,
                        validators=[djangosige.cadastros.validators.validate_cnpj],
                        verbose_name="CNPJ",
                    ),
                ),
                (
                    "inscricao_municipal",
                    models.CharField(blank=True, max_length=36, verbose_name="Inscrição Municipal"),
                ),
                ("inscricao_estadual", models.CharField(blank=True, max_length=36, verbose_name="Inscrição Estadual")),
                ("proprietario", models.CharField(blank=True, max_length=64, verbose_name="Proprietário")),
                (
                    "situacao_fiscal",
                    models.CharField(
                        blank=True,
                        ...
                        max_length=2,
                        null=True,
                        verbose_name="Situação Fiscal",
                    ),
                ),
                ("suframa", models.CharField(blank=True, max_length=16, verbose_name="SUFRAMA")),
                (
                    "pessoa",
                    models.OneToOneField(
                        on_delete=django.db.models.deletion.CASCADE, related_name="juridica", to="cadastros.pessoa"
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=11,
                        unique=True,
                        validators=[djangosige.cadastros.validators.validate_cpf],
                        verbose_name="CPF",
                    ),
                ),
                ...
                (
                    "pessoa",
                    models.OneToOneField(
                        on_delete=django.db.models.deletion.CASCADE, related_name="fisica", to="cadastros.pessoa"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("numero", models.CharField(blank=True, max_length=16, verbose_name="Número")),
                ("complemento", models.CharField(blank=True, max_length=64, verbose_name="Complemento")),
                ("bairro", models.CharField(blank=True, max_length=64, verbose_name="Bairro")),
                ("municipio", models.CharField(blank=True, max_length=64, verbose_name="Município")),
                ("uf", models.CharField(blank=True, max_length=3, verbose_name="UF")),
                ("pais", models.CharField(blank=True, default="Brasil", max_length=32, verbose_name="País")),
                ("cep", models.CharField(blank=True, max_length=16, verbose_name="CEP")),
                ("e_entrega", models.BooleanField(default=False, verbose_name="É entrega")),
                ("e_cobranca", models.BooleanField(default=False, verbose_name="É cobrança")),
                (
                    "pessoa",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="cadastros.pessoa", verbose_name="Pessoa"
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("criado", models.DateTimeField(auto_now_add=True, verbose_name="Criado")),
                ("modificado", models.DateTimeField(auto_now=True, verbose_name="Modificado")),
                ("tipo", models.CharField(blank=True, max_length=32, verbose_name="Tipo")),
                ("documento", models.TextField(blank=True, verbose_name="Documento")),
                (
                    "pessoa",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="cadastros.pessoa", verbose_name="Pessoa"
