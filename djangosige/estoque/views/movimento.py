...
from djangosige.base.custom_views import (CustomCreateView, CustomDetailView,
                                          CustomListView)
from djangosige.estoque.forms import (EntradaEstoqueForm,
                                      ItensMovimentoFormSet, SaidaEstoqueForm,
                                      TransferenciaEstoqueForm)
from djangosige.estoque.models import (EntradaEstoque, MovimentoEstoque,
                                       ProdutoEstocado, SaidaEstoque,
