...
class EstoqueAdicionarViewsTestCase(BaseTestCase):
    ...
    def test_add_entrada_estoque_view_post_request(self):
        ...
        data["tipo_movimento"] = ""
        response = self.client.post(url, data, follow=True)
        self.assertFormError(response, "form", "tipo_movimento", "Este campo é obrigatório.")
    ...
    def test_add_transferencia_estoque_view_post_request(self):
        ...
        response = self.client.post(url, data, follow=True)
        self.assertFormError(response, "form", "quantidade_itens", "Este campo é obrigatório.")
...
class EstoqueListarViewsTestCase(BaseTestCase):
    def test_list_entrada_estoque_view_deletar_objeto(self):
        ...
        self.check_list_view_delete(url=reverse("estoque:listaentradasestoqueview"), deleted_object=obj)

    def test_list_saida_estoque_view_deletar_objeto(self):
        obj = SaidaEstoque.objects.create()
        self.check_list_view_delete(url=reverse("estoque:listasaidasestoqueview"), deleted_object=obj)
    ...
    def test_list_transferencia_estoque_view_deletar_objeto(self):
        ...
        self.check_list_view_delete(url=reverse("estoque:listatransferenciasestoqueview"), deleted_object=obj)

    def test_list_todas_movimentacoes_estoque_view_deletar_objetos(self):
        obj = SaidaEstoque.objects.create()
        self.check_list_view_delete(url=reverse("estoque:listamovimentoestoqueview"), deleted_object=obj)
        obj = EntradaEstoque.objects.create()
        self.check_list_view_delete(url=reverse("estoque:listamovimentoestoqueview"), deleted_object=obj)
        obj = TransferenciaEstoque.objects.create(
            local_estoque_orig=LocalEstoque.objects.order_by("id").first(),
    ...
    def test_list_local_estoque_view_deletar_objeto(self):
        ...
        self.check_list_view_delete(url=reverse("estoque:listalocalview"), deleted_object=obj)
