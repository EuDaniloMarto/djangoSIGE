...
class ComprasAdicionarViewsTestCase(BaseTestCase):
    ...
    def test_add_orcamento_compra_view_post_request(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "compras/orcamento_compra/orcamento_compra_list.html")

        # Assert form invalido
        data["fornecedor"] = ""
        response = self.client.post(url, data, follow=True)
        self.assertFormError(response, "form", "fornecedor", "Este campo é obrigatório.")
    ...
    def test_add_pedido_compra_view_post_request(self):
        ...
        response = self.client.post(url, data, follow=True)
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "compras/pedido_compra/pedido_compra_list.html")
...
class ComprasListarViewsTestCase(BaseTestCase):
    def test_list_orcamento_compra_view_deletar_objeto(self):
        ...
        self.check_list_view_delete(url=reverse("compras:listaorcamentocompraview"), deleted_object=obj)
    ...
    def test_list_orcamento_compra_vencido_view_deletar_objeto(self):
        ...
        self.check_list_view_delete(url=reverse("compras:listaorcamentocompravencidosview"), deleted_object=obj)

    def test_list_orcamento_compra_vence_hoje_view_deletar_objeto(self):
        fornecedor = Fornecedor.objects.order_by("id").last()
        obj = OrcamentoCompra.objects.create(fornecedor=fornecedor, data_vencimento=datetime.now().date())
        self.check_list_view_delete(url=reverse("compras:listaorcamentocomprahojeview"), deleted_object=obj)

    def test_list_pedido_compra_view_deletar_objeto(self):
        fornecedor = Fornecedor.objects.order_by("id").last()
        obj = PedidoCompra.objects.create(fornecedor=fornecedor)
        self.check_list_view_delete(url=reverse("compras:listapedidocompraview"), deleted_object=obj)

    def test_list_pedido_compra_atrasado_view_deletar_objeto(self):
        fornecedor = Fornecedor.objects.order_by("id").last()
        obj = PedidoCompra.objects.create(fornecedor=fornecedor, data_entrega=datetime.now().date() - timedelta(days=1))
        self.check_list_view_delete(url=reverse("compras:listapedidocompraatrasadosview"), deleted_object=obj)

    def test_list_pedido_compra_entrega_hoje_view_deletar_objeto(self):
        fornecedor = Fornecedor.objects.order_by("id").last()
        obj = PedidoCompra.objects.create(fornecedor=fornecedor, data_entrega=datetime.now().date())
        self.check_list_view_delete(url=reverse("compras:listapedidocomprahojeview"), deleted_object=obj)
...
class ComprasAcoesUsuarioViewsTestCase(BaseTestCase):
    ...
    def test_gerar_pedido_compra(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "compras/pedido_compra/pedido_compra_edit.html")
    ...
    def test_copiar_orcamento_compra(self):
        ...
        response = self.client.get(url, follow=True)
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "compras/orcamento_compra/orcamento_compra_edit.html")
