...
from djangosige.apps.fiscal.models import MOD_NFE_ESCOLHAS
from djangosige.apps.fiscal.models import TP_AMB_ESCOLHAS
...
try:
    from pysignfe.nfe.manifestacao_destinatario import MD_CIENCIA_OPERACAO
    from pysignfe.nfe.manifestacao_destinatario import MD_CONFIRMACAO_OPERACAO
    from pysignfe.nfe.manifestacao_destinatario import MD_DESCONHECIMENTO_OPERACAO
    from pysignfe.nfe.manifestacao_destinatario import MD_OPERACAO_NAO_REALIZADA
except ImportError:
