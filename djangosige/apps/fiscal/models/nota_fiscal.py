...
class NotaFiscalSaida(NotaFiscal):
    ...
    venda = models.ForeignKey(
        "vendas.PedidoVenda", related_name="venda_nfe", on_delete=models.SET_NULL, null=True, blank=True
    )
...
class NotaFiscalEntrada(NotaFiscal):
    ...
    compra = models.ForeignKey(
        "compras.PedidoCompra", related_name="compra_nfe", on_delete=models.SET_NULL, null=True, blank=True
    )
...
class ConfiguracaoNotaFiscal(models.Model):
    ...
    orientacao_logo_danfe = models.CharField(max_length=1, choices=ORIENTACAO_LOGO_DANFE, default="H")
