...
class NotaFiscal(models.Model):
    ...
    mod = models.CharField(
        max_length=2, choices=MOD_NFE_ESCOLHAS, default="55")
    ...
    tp_emis = models.CharField(
        max_length=1, choices=TP_EMIS_ESCOLHAS, default="1")
    tp_amb = models.CharField(max_length=1, choices=TP_AMB_ESCOLHAS)
    fin_nfe = models.CharField(
        max_length=1, choices=FIN_NFE_ESCOLHAS, default="1")
    ind_final = models.CharField(
        max_length=1, choices=IND_FINAL_ESCOLHAS, default="0")
    ind_pres = models.CharField(
        max_length=1, choices=IND_PRES_ESCOLHAS, default="0")
...
class NotaFiscalSaida(NotaFiscal):
    tpnf = models.CharField(
        max_length=1, choices=TP_NFE_ESCOLHAS, default="1")
...
class ConfiguracaoNotaFiscal(models.Model):
    ...
    ambiente = models.CharField(
        max_length=1, choices=TP_AMB_ESCOLHAS, default="2")
    imp_danfe = models.CharField(
        max_length=1, choices=TP_IMP_ESCOLHAS, default="1")
