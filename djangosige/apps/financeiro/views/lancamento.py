...
from djangosige.apps.financeiro.forms import ContaPagarForm, ContaReceberForm, EntradaForm, SaidaForm
...
class MovimentoCaixaMixin(object):
    ...
    def atualizar_saldos(self, movimento):
        try:
            ultimo_mvmt = MovimentoCaixa.objects.filter(data_movimento__lt=movimento.data_movimento).latest(
                "data_movimento"
            )
