...
from djangosige.apps.cadastro.forms import CategoriaForm, MarcaForm, ProdutoForm, UnidadeForm
from djangosige.apps.cadastro.models import Categoria, Fornecedor, Marca, Produto, Unidade
...
class AdicionarProdutoView(CustomCreateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        for key in req_post:
            if "venda" in key or "custo" in key or "estoque_minimo" in key or "estoque_atual" in key:
