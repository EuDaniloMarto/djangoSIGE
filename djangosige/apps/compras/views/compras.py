...
from djangosige.apps.base.custom_views import CustomUpdateView
...
from djangosige.apps.compras.forms import OrcamentoCompraForm
from djangosige.apps.compras.forms import PagamentoFormSet
from djangosige.apps.compras.forms import PedidoCompraForm
from djangosige.apps.compras.models import ItensCompra
from djangosige.apps.compras.models import OrcamentoCompra
from djangosige.apps.compras.models import Pagamento
...
from djangosige.apps.estoque.models import ProdutoEstocado
...
class ReceberPedidoCompraView(CustomView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if pedido.movimentar_estoque:
            ...
            entrada_estoque.observacoes = f"Entrada de estoque pelo pedido de compra nº{pedido.id!s}"
        ...
        messages.success(
            request, f"<b>Pedido de compra {pedido.id!s} </b>recebido com sucesso.")
