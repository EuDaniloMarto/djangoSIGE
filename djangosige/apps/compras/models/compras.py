...
from djangosige.apps.vendas.models import MOD_FRETE_ESCOLHAS, STATUS_ORCAMENTO_ESCOLHAS, TIPOS_DESCONTO_ESCOLHAS
...
class ItensCompra(models.Model):
    produto = models.ForeignKey(
        "cadastro.Produto", related_name="compra_produto", on_delete=models.CASCADE, null=True, blank=True
    )
...
class Compra(models.Model):
    ...
    valor_total = models.DecimalField(
        max_digits=13, decimal_places=2, validators=[MinValueValidator(Decimal("0.00"))], default=Decimal("0.00")
    )
    tipo_desconto = models.CharField(max_length=1, choices=TIPOS_DESCONTO_ESCOLHAS, default="0")
    desconto = models.DecimalField(
        max_digits=15, decimal_places=4, validators=[MinValueValidator(Decimal("0.00"))], default=Decimal("0.00")
    )
