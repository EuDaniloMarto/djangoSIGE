...
urlpatterns = [
    ...
    url(
        r"orcamentovenda/listaorcamentovenda/$", views.OrcamentoVendaListView.as_view(), name="listaorcamentovendaview"
    ),
    ...
    url(r"copiarpedidovenda/(?P<pk>[0-9]+)/$", views.GerarCopiaPedidoVendaView.as_view(), name="copiarpedidovenda"),
    ...
    url(r"cancelarpedidovenda/(?P<pk>[0-9]+)/$", views.CancelarPedidoVendaView.as_view(), name="cancelarpedidovenda"),
]
