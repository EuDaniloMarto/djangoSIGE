...
from djangosige.vendas.forms import (ItensVendaFormSet, OrcamentoVendaForm,
                                     PagamentoFormSet, PedidoVendaForm)
from djangosige.vendas.models import (ItensVenda, OrcamentoVenda, Pagamento,
                                      PedidoVenda)
...
class OrcamentoVendaVencimentoHojeListView(OrcamentoVendaListView):
    ...
    def view_context(self, context):
        context["title_complete"] = (
            "ORÇAMENTOS DE VENDA COM VENCIMENTO DIA "
...
class PedidoVendaEntregaHojeListView(PedidoVendaListView):
    ...
    def view_context(self, context):
        context["title_complete"] = (
            "PEDIDOS DE VENDA COM ENTREGA DIA "
            + datetime.now().date().strftime("%d/%m/%Y")
        )
        context["add_url"] = reverse_lazy("vendas:addpedidovendaview")
        return context
