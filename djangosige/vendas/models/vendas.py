...
class ItensVenda(models.Model):
    produto = models.ForeignKey(
        "cadastro.Produto", related_name="venda_produto", on_delete=models.CASCADE, null=True, blank=True
    )
...
class Venda(models.Model):
    ...
    veiculo = models.ForeignKey(
        "cadastro.Veiculo", related_name="venda_veiculo", on_delete=models.SET_NULL, null=True, blank=True
    )
