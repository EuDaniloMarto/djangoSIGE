    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "tipo_desconto",
                    models.CharField(
                        blank=True, choices=[("0", "Valor"), ("1", "Percentual")], max_length=1, null=True
                    ),
                ),
                (
                    "desconto",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "tipo_desconto",
                    models.CharField(choices=[("0", "Valor"), ("1", "Percentual")], default="0", max_length=1),
                ),
                (
                    "desconto",
                    models.DecimalField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.CharField(
                        choices=[("0", "Aberto"), ("1", "Baixado"), ("2", "Cancelado")], default="0", max_length=1
                    ),
                ),
            ],
            bases=("vendas.venda",),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.CharField(
                        choices=[("0", "Aberto"), ("1", "Faturado"), ("2", "Cancelado"), ("3", "Importado por XML")],
                        default="0",
                        max_length=1,
                    ),
                ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="venda_cliente", to="cadastro.Cliente"
            ),
        ),
        migrations.AddField(
            model_name="venda",
        ...
        migrations.AddField(
            ...
            name="venda_id",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="parcela_pagamento", to="vendas.Venda"
            ),
        ),
        migrations.AddField(
            ...
            name="venda_id",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="itens_venda", to="vendas.Venda"
            ),
        ),
    ]
