...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name="categoria",
            field=models.ForeignKey(
                blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to="cadastro.categoria"
            ),
        ),
        migrations.AlterField(
            model_name="produto",
            name="cfop_padrao",
            field=models.ForeignKey(
                blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to="fiscal.naturezaoperacao"
            ),
        ),
        migrations.AlterField(
            model_name="produto",
            name="grupo_fiscal",
            field=models.ForeignKey(
                blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to="fiscal.grupofiscal"
            ),
        ),
        migrations.AlterField(
            model_name="produto",
            name="marca",
            field=models.ForeignKey(
                blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to="cadastro.marca"
            ),
        ),
        migrations.AlterField(
            model_name="produto",
            name="unidade",
            field=models.ForeignKey(
                blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to="cadastro.unidade"
            ),
        ),
    ]
