    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "tipo_pessoa",
                    models.CharField(choices=[("PF", "Pessoa Física"), ("PJ", "Pessoa Jurídica")], max_length=2),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "categoria",
                    models.ForeignKey(
                        blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to="cadastro.Categoria"
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        choices=[("FIX", "Fixo"), ("CEL", "Celular"), ("FAX", "Fax"), ("OUT", "Outro")],
                        max_length=8,
                        null=True,
                    ),
                ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="telefone", to="cadastro.Pessoa"
            ),
        ),
        migrations.AddField(
            model_name="site",
