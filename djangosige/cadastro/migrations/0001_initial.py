    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('banco_padrao', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ban_padrao', to='cadastro.banco')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('pessoa_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='cadastro.pessoa')),
                ('logo_file', models.ImageField(blank=True, default='imagens/logo.png', null=True, upload_to=djangosige.cadastro.models.empresa.logo_directory_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pessoa_documento', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='documento', to='cadastro.pessoa')),
            ],
        ),
        migrations.AddField(
            model_name='pessoa',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('m_usuario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='empresa_usuario', to='login.usuario')),
            ],
        ),
        migrations.CreateModel(
            name='Produto',
