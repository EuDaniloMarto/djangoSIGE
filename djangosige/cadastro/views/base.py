...
from djangosige.base.custom_views import (CustomCreateView, CustomListView,
                                          CustomUpdateView)
from djangosige.cadastro.forms import (BancoFormSet, DocumentoFormSet,
                                       EmailFormSet, EnderecoFormSet,
                                       PessoaFisicaForm, PessoaJuridicaForm,
                                       SiteFormSet, TelefoneFormSet)
from djangosige.cadastro.models import (Banco, Documento, Email, Endereco,
                                        PessoaFisica, PessoaJuridica, Site,
                                        Telefone)
