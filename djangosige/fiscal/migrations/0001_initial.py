    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "regime_trib",
                    models.CharField(
                        choices=[("0", "Tributação Normal"), ("1", "Simples Nacional")],
                        max_length=1,
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "icms_incluido_preco",
                    models.BooleanField(default=False, help_text="calculo-icms"),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(default=False, help_text="calculo-icmssn"),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "ipi_incluido_preco",
                    models.BooleanField(default=False, help_text="calculo-ipi"),
                ),
                (
                    "incluir_bc_icms",
                    models.BooleanField(default=False, help_text="calculo-ipi"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "versao",
                    models.CharField(
                        choices=[("3.10", "v3.10")], default="3.10", max_length=4
                    ),
                ),
                ...
                (
                    "mod",
                    models.CharField(
                        choices=[("55", "NF-e (55)"), ("65", "NFC-e (65)")],
                        default="55",
                        max_length=2,
                    ),
                ),
                ...
                (
                    "tp_amb",
                    models.CharField(
                        choices=[("1", "Produção"), ("2", "Homologação")], max_length=1
                    ),
                ),
                (
                    "fin_nfe",
