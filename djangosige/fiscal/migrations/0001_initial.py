    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "ambiente",
                    models.CharField(choices=[("1", "Produção"), ("2", "Homologação")], default="2", max_length=1),
                ),
                (
                    "imp_danfe",
                    models.CharField(
                ...
                (
                    ...
                    models.CharField(choices=[("H", "Horizontal"), ("V", "Vertical")], default="H", max_length=1),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "tipo",
                    models.CharField(blank=True, choices=[("0", "Erro"), ("1", "Alerta")], max_length=1, null=True),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "regime_trib",
                    models.CharField(choices=[("0", "Tributação Normal"), ("1", "Simples Nacional")], max_length=1),
                ),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "tipo_ipi",
                    models.CharField(
                        choices=[("0", "Não sujeito ao IPI"), ("1", "Valor fixo"), ("2", "Alíquota")],
                        default="2",
                        max_length=1,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "tp_operacao",
                    models.CharField(
                        blank=True, choices=[("0", "0 - Entrada"), ("1", "1 - Saída")], max_length=1, null=True
                    ),
                ),
                (
                    "id_dest",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "indpag",
                    models.CharField(
                        choices=[("0", "Pagamento à vista"), ("1", "Pagamento a prazo"), ("2", "Outros")], max_length=1
                    ),
                ),
                (
                    "mod",
                    models.CharField(choices=[("55", "NF-e (55)"), ("65", "NFC-e (65)")], default="55", max_length=2),
                ),
                ...
                (
                    "tp_emis",
                    models.CharField(
                        choices=[("1", "Emissão normal"), ("2", "Emissão em contingência")], default="1", max_length=1
                    ),
                ),
                ...
                (
                    "ind_final",
                    models.CharField(choices=[("0", "0 - Não"), ("1", "1 - Sim")], default="0", max_length=1),
                ),
                (
                    "ind_pres",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "n_nf_entrada",
                    models.CharField(max_length=9, validators=[django.core.validators.RegexValidator("^\\d{1,10}$")]),
                ),
                (
                    "compra",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "n_nf_saida",
                    models.CharField(
                        max_length=9, unique=True, validators=[django.core.validators.RegexValidator("^\\d{1,10}$")]
                    ),
                ),
        ...
        migrations.AddField(
            ...
            name="nfe",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="erros_nfe_sefaz", to="fiscal.NotaFiscalSaida"
            ),
        ),
        migrations.AddField(
            ...
            name="nfe",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="erros_nfe", to="fiscal.NotaFiscalSaida"
            ),
        ),
        migrations.AddField(
            model_name="autxml",
            name="nfe",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="aut_xml", to="fiscal.NotaFiscalSaida"
            ),
        ),
    ]
