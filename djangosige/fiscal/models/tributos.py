...
CST_ICMS_ESCOLHAS = (
    ...
    ("10p", "10 - Tributada e com cobrança do ICMS por substituição tributária (com partilha do ICMS)"),
...
class ICMS(models.Model):
    ...
    mod_bcst = models.CharField(
        max_length=1, choices=MOD_BCST_ESCOLHAS, default="4", help_text="icms10 icms30 icms70 icms90 icms10p icms90p"
    )
    ...
    ufst = models.CharField(max_length=2, choices=UF_SIGLA, null=True, blank=True, help_text="icms10p icms90p")
...
class ICMSUFDest(models.Model):
    p_fcp_dest = models.DecimalField(
        max_digits=6, decimal_places=2, validators=[MinValueValidator(Decimal("0.00"))], null=True, blank=True
    )
...
class ICMSSN(models.Model):
    ...
    mod_bc = models.CharField(max_length=1, choices=MOD_BC_ESCOLHAS, default="3", help_text="icmssn900")
    mod_bcst = models.CharField(
        max_length=1, choices=MOD_BCST_ESCOLHAS, default="4", help_text="icmssn201 icmssn202 icmssn203 icmssn900"
    )
    p_mvast = models.DecimalField(
        max_digits=6,
        decimal_places=2,
...
class IPI(models.Model):
    ...
    valor_fixo = models.DecimalField(
        max_digits=13, decimal_places=2, validators=[MinValueValidator(Decimal("0.00"))], null=True, blank=True
...
class PIS(models.Model):
    ...
    p_pis = models.DecimalField(
        max_digits=5, decimal_places=2, validators=[MinValueValidator(Decimal("0.00"))], null=True, blank=True
    )
