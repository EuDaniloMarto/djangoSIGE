...
class EditarNotaFiscalSaidaView(EditarNotaFiscalView):
    ...
    def view_context(self, context):
        context["title_complete"] = (
            "EDITAR NOTA FISCAL DE SAÍDA " + str(self.object.serie) + "/" + str(self.object.n_nf_saida)
        )
        context["return_url"] = reverse_lazy("fiscal:listanotafiscalsaidaview")
        context["saida"] = True
        return context
...
class EditarNotaFiscalEntradaView(EditarNotaFiscalView):
    ...
    def view_context(self, context):
        context["title_complete"] = (
            "EDITAR NOTA FISCAL DE ENTRADA " + str(self.object.serie) + "/" + str(self.object.n_nf_entrada)
        )
...
class CancelarNotaView(CustomTemplateView):
    template_name = "fiscal/nota_fiscal/nota_fiscal_sefaz.html"
    permission_codename = ["view_notafiscalsaida", "change_notafiscalsaida", "cancelar_notafiscal"]
...
class InutilizarNotasView(CustomTemplateView):
    template_name = "fiscal/nota_fiscal/nota_fiscal_sefaz.html"
    permission_codename = ["view_notafiscalsaida", "change_notafiscalsaida", "inutilizar_notafiscal"]
...
class ConsultarNotaView(CustomTemplateView):
    template_name = "fiscal/nota_fiscal/nota_fiscal_sefaz.html"
    permission_codename = ["view_notafiscalsaida", "change_notafiscalsaida", "consultar_notafiscal"]
...
class BaixarNotaView(CustomTemplateView):
    template_name = "fiscal/nota_fiscal/nota_fiscal_sefaz.html"
    permission_codename = ["view_notafiscalsaida", "change_notafiscalsaida", "baixar_notafiscal"]
