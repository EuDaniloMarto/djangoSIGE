...
from djangosige.cadastro.models import (COD_UF, Cliente, Empresa, Endereco,
                                        Fornecedor, PessoaFisica,
                                        PessoaJuridica, Produto, Telefone,
                                        Transportadora, Unidade)
from djangosige.compras.models import ItensCompra, PedidoCompra
from djangosige.configs.settings import MEDIA_ROOT
from djangosige.fiscal.models import (COFINS, ICMS, ICMSSN, IPI, PIS, AutXML,
                                      ConfiguracaoNotaFiscal,
                                      ErrosValidacaoNotaFiscal, GrupoFiscal,
                                      ICMSUFDest, NaturezaOperacao,
