...
urlpatterns = [
    ...
    url(r"copiarpedidocompra/(?P<pk>[0-9]+)/$", views.GerarCopiaPedidoCompraView.as_view(), name="copiarpedidocompra"),
    # Cancelar Pedido de compra
    url(
        r"cancelarpedidocompra/(?P<pk>[0-9]+)/$", views.CancelarPedidoCompraView.as_view(), name="cancelarpedidocompra"
    ),
    ...
    url(r"receberpedidocompra/(?P<pk>[0-9]+)/$", views.ReceberPedidoCompraView.as_view(), name="receberpedidocompra"),
]
